...
// Renders the Point Expiry & Tier Progression Report using the shared loyalty report UI,
// mirroring HousekeepingReport/RoomCleaningPerformanceUI.
public class PointExpiryUI {

    private static final String TITLE = "POINT EXPIRY & TIER PROGRESSION REPORT";

    private final ReportUI ui;

    public PointExpiryUI(ReportUI ui) {
        this.ui = ui;
    }

    public void render(PointExpiryReport.Result result) {
